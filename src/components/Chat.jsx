  ...
  return (
    <div className="relative">
      <div>
        ...
        {/* Chat positioned in right corner */}
        {show && (
          <div className="fixed top-4 right-4 z-50 w-80 max-w-[90vw] max-h-[80vh]">
            <div className="overflow-hidden bg-[#2D1B69] rounded-xl shadow-2xl border border-[#8B5CF6]">
              <div
                className="text-gray-200 rounded-t-lg p-3 border-b-2 border-tertiary bg-primary"
              ...
              >
                <div className="flex flex-row justify-between items-center">
                  ...
                  <button
                    ...
                    className="hover:bg-opacity-70 cursor-pointer text-lg text-white font-bold py-1 px-2 rounded-full"
                  >
                    <IoClose size={24} />
                  </button>
                </div>
              </div>
              <div className="h-[50vh] overflow-y-auto overflow-x-hidden p-3 hideScroll">
              ...
              <form onSubmit={handelSubmit} className="p-3 border-t border-[#8B5CF6] bg-[#2D1B69]">
